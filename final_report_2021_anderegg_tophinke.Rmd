...
A summary of all analyzed tracks is shown in table 1. This shows that activities in a distance range from 3,178 to 15.644 kilometers were used. The positive altitude difference per track were between 38.3 and 1112.6 m, the negative altitude difference was measured between -37.6 and -1191.6 m. It also shows the average pace (time required per kilometer of distance). The pace seems to be dependent on the distance and the altitude differences in the sense of an explorative data analysis.
