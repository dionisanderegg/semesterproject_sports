...
### 3.1 Comparison tracked data vs. calculated data <a name="subparagraph1"></a>
...
### 3.1 Research Question 1 <a name="subparagraph1"></a>
...
shinyAppDir(
  system.file("Markdown.Rmd", package="shiny"),
  options = list(width = "100%", height = 700)
)

```

### 3.2 Research Question 2 <a name="subparagraph1"></a>

In this chapter the goal was to indicate specific behavioural patterns (e.g. speed, breaks, or similar) in the sports data and when they occur.

### 3.3 Research Question 3 <a name="subparagraph1"></a>
