...
# Import
Alle Files mit Endung .fit importieren und in ein einzelnes Data.frame zusammenführen. Alle anderen Data.frames löschen, sodass nur noch das gesamte DF im Workspace ist.
```{r}
