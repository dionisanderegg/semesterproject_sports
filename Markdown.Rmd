...
zf %>% 
  dplyr::select(activity_ID, time_measured = time, time_estimated_min, distance, hightdiff_up, hightdiff_down) %>%
...
zf %>%
  ggplot(aes(time, time_estimated_min)) +
  geom_abline(intercept = 0, slope = 1) +
  geom_label(aes(label = activity_ID, vjust = 1)) +
  xlim(0, 200) +
  ylim(0,200) +
  geom_point()
